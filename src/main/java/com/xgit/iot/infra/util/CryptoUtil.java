...
public class CryptoUtil {
     ...
     * @return 加密后字符串
     */
    public static String encryptHMACSha256(String message, String secret) throws Exception{
        String hash = "";
        Mac sha256_HMAC = Mac.getInstance(KEY_MAC_256);
        SecretKeySpec secret_key = new SecretKeySpec(secret.getBytes(), KEY_MAC_256);
